...
export function TankConfiguration({ onNext, isLoading, data }: TankConfigurationProps) {
  ...
  const options = [
    {
      ...
      description: 'I already have a water storage tank that can be used for rainwater harvesting',
      benefits: [
    ...
    },
    {
      ...
      description: 'I need to install a new water storage tank for rainwater harvesting',
      benefits: [
    ...
    <Card className="shadow-xl border-0 bg-white/80 backdrop-blur">
      <CardHeader className="text-center">
        ...
        <p className="text-gray-600">
          This helps us determine the best approach for your rainwater harvesting system
        </p>
      </CardHeader>
      <CardContent>
