...
export function TankCapacitySelection({ onNext, isLoading, data }: TankCapacitySelectionProps) {
  const [selectedCapacity, setSelectedCapacity] = useState<number | null>(data.tankCapacity || null);
