...
export function SystemBlueprint({ userData, results }: SystemBlueprintProps) {
  const components = [
    {
    ...
    },
    {
      ...
      quantity: 1,
      unit: 'unit',
      priceRange: userData.tankCapacity <= 1000 ? '₹12,000 - ₹18,000' : 
                  userData.tankCapacity <= 5000 ? '₹35,000 - ₹50,000' : 
                  '₹60,000 - ₹2,50,000',
      description: userData.hasTank ? 'Modification of existing tank' : 'New storage tank installation'
    },
    {
  ...
  const totalEstimate = {
    materials: userData.useType === 'household' ? 
      (userData.tankCapacity <= 1000 ? 35000 : userData.tankCapacity <= 5000 ? 65000 : 120000) :
      (userData.tankCapacity <= 25000 ? 180000 : 350000),
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Rooftop Collection</span>
                  </div>
                  <div className="pl-5 text-gray-600">↓</div>
                  <div className="flex items-center gap-2">
                ...
                <tbody>
                  {components.map((component, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 text-center">{component.quantity} {component.unit}</td>
                ...
                <div className="space-y-3">
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    <p className="text-sm text-gray-600">
                      {userData.useType === 'household' ? '3-5 days' : '1-2 weeks'} 
                      (weather dependent)
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Building permission for structural modifications (if any)
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="font-medium text-gray-800">Maintenance</p>
                    <p className="text-sm text-gray-600">
                      Quarterly filter cleaning, annual system inspection
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="font-medium text-gray-800">Warranty</p>
                    <p className="text-sm text-gray-600">
                      2 years on equipment, 5 years on tank
                    </p>
                  </div>
                </div>
              </div>
          ...
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Download your complete rainwater harvesting system blueprint including detailed drawings, 
                component specifications, installation guide, and maintenance schedule.
              </p>
